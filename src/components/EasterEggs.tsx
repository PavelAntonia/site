...
const SECRET_FACTS = [
  ...
  "Curiosity unlocked. Thanks for exploring.",
  "Hidden message: keep building great things.",
  "Small surprises make products memorable.",
  "You found a secret. That is attention to detail.",
  "Bonus: you triggered a hidden message.",
];
      ...
      <AnimatePresence>
        {state.konamiActive && (
          ...
          >
            ...
            <p className="text-sm mt-1">Bonus experience points</p>
          </motion.div>
        )}
      </AnimatePresence>
    </>
